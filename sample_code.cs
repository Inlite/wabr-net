...
delegate void delShowBarcodes(WABarcode[] barcodes);
delegate void delShowError(Exception ex);

class Test
    {
    // Image selection
    internal bool bTestDropBox = true;
    internal bool bTestSamplesLocal = true;
    internal bool bTestSamplesWeb = true;
    internal bool bTestBase64 = true;
    internal bool bTestUtf8 = true;
    internal bool bTestUtf8Names = true;

    // Async control
    internal bool bUseAsync = false;

    // Testing
    internal bool bShowDiag = false;  // true is for TEST only
    internal int count, errors;

    internal delShowBarcodes showBarcodes = ShowBarcodes;
    internal delShowError showError = ShowError;
    internal delReaderCallback callback = null;



    internal static string samplesLocal = "../../";  // Project directory above /bin/Debug
    internal static string samplesWeb = "https://wabr.inliteresearch.com/SampleImages/";
